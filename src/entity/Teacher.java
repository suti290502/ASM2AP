...
public class Teacher extends Person implements NotifyInterface {
    ...
    public String toString() {
        return String.format("%-5s | %-20s | %-10s | %-10s | %-10s | %-12s | %-20s | %-10s | %-10s | %-10s | %-10s | %-15s | %-15s | %-10s",
                getId(), getName(), getAddress(), getPhone(), getPersonId(), getBirthDay(), getEmail(),
                getTeacherCode(), getSalaryLevel(), getMaxDegree(), getMajor(), getTaxCode(), getInsuranceCode(), getSalary());
    }
